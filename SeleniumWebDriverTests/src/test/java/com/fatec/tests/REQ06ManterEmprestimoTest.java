 ...
 * 
 *    REQ06. O sistema deve permitir o registro de um empréstimo, associando o livro emprestado ISBN ao RA do
 *    aluno. O aluno pode realizar somente um empréstimo por vez. A data da devolução é de 8 dias não contando a
 *    data do empréstimo.
 *   
 */
...
public class REQ06ManterEmprestimoTest {
